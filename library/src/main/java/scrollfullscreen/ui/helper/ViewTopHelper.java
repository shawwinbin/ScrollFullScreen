...
public class ViewTopHelper {
    ...
    private void applyAnimationToTarget(int from, Animation animation, Animation.AnimationListener listener, int duration) {
        this.from = from;
        animation.reset();
    ...
    /**
     * Set view's offsetTopAndBottom
     * @param offset
     */
    private void setTargetOffsetTopAndBottom(int offset) {
        target.get().offsetTopAndBottom(offset);
        currentTargetOffsetTop = target.get().getTop();
    }
}
